...
export const metadata: Metadata = {
  ...
  keywords: ['cow protection', 'goshala', 'udupi', 'brahmavar', 'donate', 'NGO', 'India', 'kamadhenu'],
  openGraph: {
    title: 'Kamadhenu Trust',
    description: 'A sacred mission to protect and nurture 300+ cows in rural Udupi, India.',
    type: 'website',
  },
}
