  ...
  return (
    <section className="py-16 px-6" style={{ background: '#FFFFFF' }}>
      <div className="max-w-5xl mx-auto text-center">
        ...
        <p className="font-cinzel text-saffron-500 text-xs tracking-[0.3em] uppercase mb-3">{t('Powered By', 'ಇವರಿಂದ ನಡೆಸಲ್ಪಡುತ್ತಿದೆ')}</p>
        ...
        <div className="flex justify-center max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-8 border border-saffron-200/40 shadow-sm hover:shadow-md transition-shadow max-w-md w-full">
            <div className="w-16 h-16 rounded-xl bg-saffron-100 flex items-center justify-center mx-auto mb-4">
              <span className="font-cinzel font-black text-saffron-500 text-2xl">L</span>
            </div>
            <h3 className="font-cinzel font-semibold text-saffron-900 text-lg mb-2">
              Lcode Technologies Pvt. Ltd.
            </h3>
            ...
            <p className="font-cinzel text-saffron-500 text-xs tracking-wide">{t('Mangalore, Karnataka', 'ಮಂಗಳೂರು, ಕರ್ನಾಟಕ')}</p>
          </div>
        </div>

        <p className="font-lora italic text-saffron-800 text-sm mt-12 max-w-lg mx-auto">
          {t('Are you a business or individual who wishes to support this mission? ', 'ನೀವು ಈ ಧ್ಯೇಯವನ್ನು ಬೆಂಬಲಿಸಲು ಬಯಸುವ ವ್ಯಾಪಾರ ಅಥವಾ ವ್ಯಕ್ತಿಯೇ? ')}
          <Link href="/#contact" className="text-saffron-500 hover:underline">
            {t('Contact us to partner with the trust.', 'ಟ್ರಸ್ಟ್‌ನೊಂದಿಗೆ ಪಾಲುದಾರರಾಗಲು ನಮ್ಮನ್ನು ಸಂಪರ್ಕಿಸಿ.')}
          </Link>
        </p>
        </ScrollReveal>
      </div>
