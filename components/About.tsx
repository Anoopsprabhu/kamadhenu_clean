  ...
  return (
    <section id="about" className="py-16 px-6" style={{ background: '#FFFFFF' }}>
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-cinzel font-bold text-saffron-900 mb-5" style={{ fontSize: 'clamp(2rem, 4vw, 3rem)' }}>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div>
            <h3 className="font-cinzel font-semibold text-saffron-900 text-2xl mb-5">
              {t('A Labour of Love in Brahmavar', 'ಬ್ರಹ್ಮಾವರದಲ್ಲಿ ভালোবাসೆಯ ಶ್ರಮ')}
            </h3>
            <div className="space-y-4 font-lora text-saffron-800 leading-relaxed">
              <p>
                ...
                <strong className="text-saffron-600">{t('dedicated couple', 'ಮೀಸಲಾದ ದಂಪತಿಗಳು')}</strong>
                {t(' who have devoted their lives to this cause.', ' ನಡೆಸುತ್ತಿದ್ದಾರೆ, ಅವರು ಈ ಉದ್ದೇಶಕ್ಕಾಗಿ ತಮ್ಮ ಜೀವನವನ್ನು ಮುಡಿಪಾಗಿಟ್ಟಿದ್ದಾರೆ.')}
              </p>
              <p>
                {t('From dawn to dusk, they tend to over ', 'ಬೆಳಗಿನಿಂದ ಸಂಜೆಯವರೆಗೆ, ಅವರು ')}
                <strong className="text-saffron-500">{t('300 cows', '300 ಕ್ಕೂ ಹೆಚ್ಚು ಹಸುங்களை')}</strong>
                {t(
              ...
              <p>
                {t('Located in ', 'ಇದು ')}
                <strong className="text-saffron-600">{t('Brahmavar Taluk, Udupi District', 'ಬ್ರಹ್ಮಾವರ ತಾಲೂಕು, ಉಡುಪಿ ಜಿಲ್ಲೆ')}</strong>
                {t(
