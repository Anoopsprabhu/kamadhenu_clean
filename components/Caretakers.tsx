          ...
          <div className="mt-20">
            <div className="text-center mb-10">
              ...
              <p className="font-lora text-saffron-700 italic">
                {t("Glimpses of daily life and sacred rituals at the trust", "ಟ್ರಸ್ಟ್‌ನಲ್ಲಿ ದೈನಂದಿನ ಜೀವನ ಮತ್ತು ಪವಿತ್ರ ಆಚರಣೆಗಳ ನೋಟಗಳು")}
              </p>
              <div className="divider-sacred max-w-xs mx-auto mt-4" />
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-stretch">
              ...
              <div className="bg-white rounded-3xl overflow-hidden shadow-xl border border-saffron-200/50 flex flex-col h-full">
                <div className="relative aspect-[9/16] md:aspect-video bg-black flex-1">
                  <video 
                    controls 
                ...
                <div className="p-6 bg-saffron-50/50">
                  <h4 className="font-cinzel font-semibold text-saffron-900 mb-1">{t("Life at Goshala", "ಗೋಶಾಲೆಯ ಜೀವನ")}</h4>
                  <p className="font-lora text-sm text-saffron-800">{t("A short glimpse into the peaceful environment.", "ಶಾಂತಿಯುತ ಪರಿಸರದ ಒಂದು ಸಣ್ಣ ನೋಟ.")}</p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-3xl overflow-hidden shadow-xl border border-saffron-200/50 flex flex-col h-full">
                ...
                <div className="p-6 bg-saffron-50/50">
                  <h4 className="font-cinzel font-semibold text-saffron-900 mb-1">{t("Documentary", "ಸಾಕ್ಷ್ಯಚಿತ್ರ")}</h4>
                  <p className="font-lora text-sm text-saffron-800">{t("Understanding our mission and the journey so far.", "ನಮ್ಮ ಮಿಷನ್ ಮತ್ತು ಇಲ್ಲಿಯವರೆಗಿನ ಪ್ರಯಾಣವನ್ನು ಅರ್ಥಮಾಡಿಕೊಳ್ಳುವುದು.")}</p>
                </div>
              </div>
            </div>
          </div>
